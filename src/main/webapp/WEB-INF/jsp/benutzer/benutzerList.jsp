		...
		<div class="col-sm-2">
			<div class="form-group" class="form-inline">
				...
				<select class="form-control form-control-sm" id="sel1" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
					<option></option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=5&pageNo=${pageNo}">5</option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=10&pageNo=${pageNo}">10</option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=20&pageNo=${pageNo}">20</option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=50&pageNo=${pageNo}">50</option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=100&pageNo=${pageNo}">100</option>
					<option value="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=200&pageNo=${pageNo}">200</option>
		...
		<div class="container">
			<ul class="pagination justify-content-center" style="margin: 20px 0">
				...
				<li class="page-item ${pageNo == 1 ? 'disabled' : '' }"><a
					class="page-link"
					href="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=${pageSize}&pageNo=<%=previous%>"><spring:message
							code="label.button.previous" /></a></li>
				<c:forEach begin="1" end="${pages}" var="pageNumber">
					<li class="page-item ${pageNo == pageNumber ? 'active' : ''}"><a
						class="page-link"
						href="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=${pageSize}&pageNo=${pageNumber}">${pageNumber}</a></li>
				</c:forEach>

				<li class="page-item ${pageNo == pages ? 'disabled' : '' }"><a
					class="page-link"
					href="${pageContext.request.contextPath}/benutzer/allebenutzer/?pageSize=${pageSize}&pageNo=<%=next%>"><spring:message
